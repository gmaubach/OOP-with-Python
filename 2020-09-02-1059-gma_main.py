...
if __name__ == "__main__":
    ...
    # loeseEntfernungsmesser2_Musterloesung

    #--------------------------------------------------------------------------
    # In Schleifen:
    # continue: aktueller Schleifendurchlauf wird abgebrochen und die Schleife
    #           wird dann mit dem nächsten Wert fortgesetzt.
    # break: aktueller Schleifendurchlauf wird vollständig abgebrochen. Das
    #        Programm wird mit dem nächsten Befehl nach der Schleife fort-
    #        gesetzt.
    #--------------------------------------------------------------------------
